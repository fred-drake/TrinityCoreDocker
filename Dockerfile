...
ARG latest_commit=53e1666a93d4d4d595b8707a39a88395030108ae
...
RUN apt-get remove -y git clang cmake make gcc g++ libmariadb-dev libssl-dev libbz2-dev libreadline-dev libncurses-dev \
